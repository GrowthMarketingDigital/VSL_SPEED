...
const Termos = () => {
  return (
    <div className="main">
      <h4>Esta política de Termos de Uso é válida a partir de Dec 2023.</h4><br />
      <h2>TERMOS DE USO — site</h2> <br />
      <p>site, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site site.com.br e qualquer outro site, loja ou aplicativo operado pelo proprietário.</p><br />
      <p>Ao navegar neste website, consideramos que você está de acordo com os Termos de Uso abaixo.</p><br />
      <p>Caso você não esteja de acordo com as condições deste contrato, pedimos que não faça mais uso deste website, muito menos cadastre-se ou envie os seus dados pessoais.</p><br />
      <p>Se modificarmos nossos Termos de Uso, publicaremos o novo texto neste website, com a data de revisão atualizada. Podemos alterar este documento a qualquer momento. Caso haja alteração significativa nos termos deste contrato, podemos informá-lo por meio das informações de contato que tivermos em nosso banco de dados ou por meio de notificações.</p><br />
      <p>A utilização deste website após as alterações significa que você aceitou os Termos de Uso revisados. Caso, após a leitura da versão revisada, você não esteja de acordo com seus termos, favor encerrar o seu acesso.</p><br />
      ...
      <br /><div className="internalMain">
        <h5>Seção 2 - Adesão em conjunto com a Política de Privacidade</h5>
        <p>A utilização deste website acarreta a adesão aos presentes Termos de Uso e a versão mais atualizada da Política de Privacidade de site.</p>
      </div>

      <br /><div className="internalMain">
        <h5>Seção 3 - Condições de acesso</h5>
        <p>Em geral, o acesso ao website da site possui caráter gratuito e não exige prévia inscrição ou registro.</p>
        ...
        <p>Partes deste website oferecem ao usuário a opção de publicar comentários em determinadas áreas. site não consente com a publicação de conteúdos que tenham natureza discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de autor ou quaisquer outros direitos de terceiros.</p>
        <p>A publicação de quaisquer conteúdos pelo usuário deste website, incluindo mensagens e comentários, implica em licença não-exclusiva, irrevogável e irretratável, para sua utilização, reprodução e publicação pela site no seu website, plataformas e aplicações de internet, ou ainda em outras plataformas, sem qualquer restrição ou limitação.</p>
      </div>
      ...
      <br /><div className="internalMain">
        ...
        <p>Todos os elementos de site são de propriedade intelectual da mesma ou de seus licenciados. Estes Termos ou a utilização do website não concede a você qualquer licença ou direito de uso dos direitos de propriedade intelectual da site ou de terceiros.</p>
      </div>
      ...
      <br /><div className="internalMain">
        ...
        <p>O website no todo ou em cada uma das suas seções, pode ser encerrado, suspenso ou interrompido unilateralmente por site, a qualquer momento e sem necessidade de prévio aviso.</p>
      </div>

      <br /><div className="internalMain">
        <h5>Seção 8 - Dados pessoais</h5>
        <p>Durante a utilização deste website, certos dados pessoais serão coletados e tratados por site e/ou pelos Parceiros. As regras relacionadas ao tratamento de dados pessoais de site estão estipuladas na Política de Privacidade.</p>
      </div>

      <br /><div className="internalMain">
        <h5>Seção 9 - Contato</h5>
        <p>Caso você tenha qualquer dúvida sobre os Termos de Uso, por favor, entre em contato pelo e-mail <a href="mailto:growthmktmaterial@gmail.com">growthmktmaterial@gmail.com</a>.</p>
      </div>
    </div>
  )
}
